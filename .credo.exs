  ...
  configs: [
    %{
      ...
      checks: %{
        ...
        disabled: [
          # Allow TODO comments in development code
          {Credo.Check.Design.TagTODO, []},
          # Disable for shorter alias imports
          {Credo.Check.Design.AliasUsage, []},
          # Allow single pipe operations for clarity
          {Credo.Check.Refactor.PipeChainStart, []},
          # Disable unsupported checks for Elixir 1.18
